...
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD') #Enter your password hilk eeys wnil dpjh
...
DATABASES = {
    'default': {
        ...
        'NAME': 'koyebdb',
        'USER': 'koyeb-adm',
        'PASSWORD': 'UARlX6Nbo4gy',
        'HOST': 'ep-lingering-rice-a425fz13.us-east-1.pg.koyeb.app',
