  ...
  return show ? (
    ...
    <meta name="description" content="Explore J's portfolio, elevate brand with creative solutions"></meta>
      ...
      <div className='hero-text' >
        <h1 className='font-poppins '>OUR PROJECTS</h1>
        <p className='font-poppinslight'>We are good at building web apps that are use by millions of people and platforms that serve blossoming businesses.</p>
      </div>
      <div className='sites'>
