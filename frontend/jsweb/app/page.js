...
export default function Home() {
  ...
  return show ? (
    <main className="flex flex-col bg-main-bg font-lora overflow-x-hidden">
      ...
      <section className='md:px-32 sm:px-24 px-12 bg-black flex flex-col' id='hero'>
        <div className="h-screen flex flex-col justify-center text-white md:w-3/4 w-full space-y-12">
          ...
          <Link href={"/about-us"} className='flex flex-row space-x-2 text-sm'>
            <p>GET TO KNOW US</p>
            <Image
            src={"/arrow-right.svg"}
            alt='arrow'
      ...
      <section className='flex flex-col w-full justify-center items-start space-y-6 bg-alt-bg px-16 py-28
      ...
      xl:py-44 '>
        ...
        <div className='flex flex-col md:w-1/2 space-y-6'>
          <p className='md:border-l-[3px] text-start h-full border-black w-full md:pl-4 font-medium font-lato'>We are committed to launching businesses, elevating their enterprise value, and redefining their market penetration strategies. Through innovation and dedicated effort, we aim to bring joy and success to our clients.</p>
          <Link href={''}>
